...
class TableList extends Component {
    ...
    constructor(props) {
        ...
        this._categoryID = this.props.match.params.id;
    }
    ...
    render() {
        ...
        const ClearSearchButton = (props) => {
            ...
            return ( <button className = "btn btn-default" onClick = { handleReset }> Clear</button>
            )
        }
        ...
        return ( <
            ...
            search > {
                props => ( <div>
                    ...
                    <hr />
                    <BootstrapTable keyField = 'id' remote = {
                        { filter: true, pagination: true, sort: true, cellEdit: false, search: true }
                    }
                    pagination = { paginatioFactory }
                    onTableChange = { onTableChange } {...props.baseProps }
                    /> </div>
                )
            } </ToolkitProvider>
        )
...
class Category extends Component {
    ...
    handleSubmit(e, formData, inputs) {
        ...
        let url = 'members/category';
        if (this._categoryID) {
            formData['_method'] = 'PUT';
            url = `members/category/${this._categoryID}`;
        }
    ...
    render() {
        ...
        return ( 
                ...
                <div className = "col-md-6" >
                    <ValidationForm 
                        ...
                        <div className = "form-group">
                            ...
                            <TextInput 
                                ...
                                id = "name" 
                                type = "text" 
                                required errorMessage = {{ required: "Name is required" }} 
                    ...
                    <div className = "form-group" >
                        ...
                        <TextInput 
                            name = "descriptions" 
                            id = "descriptions" 
                            multiline value = { this.state.descriptions } 
                            onChange = { this.handleChange }/> 
                    </div> 
            ...
            <div className = "col-md-6" >
                <Link className = "btn btn-success" to = { '/categories' }>Add New</Link> 
