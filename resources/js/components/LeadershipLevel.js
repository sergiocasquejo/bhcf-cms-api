...
class TableList extends Component {
    ...
    constructor(props){
        ...
        this._leadershipLevelID = this.props.match.params.id;
    }
...
class LeadershipLevel extends Component {
    _isMounted = false;
    _isFormSubmit =  false;
    _leadershipLevelID = null;
    constructor(props){
        super(props);
    ...
    selectedItem(e, item) {
        this._leadershipLevelID = item.id;
    ...
    handleSubmit(e, formData, inputs) {
        ...
        let url = 'leadership-levels';
        if (this._leadershipLevelID) {
            formData['_method'] = 'PUT';
            url = `leadership-levels/${this._leadershipLevelID}`;
        }
        ...
        api.post(url, formData).then(res => {
            if (this._isMounted) {
                ...
                if (response.ok) {
                    ...
                    this.props.history.push(`leadership-levels`);
                }else {
    ...
    render() {
        ...
        return (
            <div className="row">
                ...
                <div className="col-md-6">
                    <Link className="btn btn-success" to={'/leadership-levels'}>Add New</Link>
