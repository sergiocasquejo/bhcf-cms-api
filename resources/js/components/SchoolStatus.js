...
class TableList extends Component {
    ...
    constructor(props){
        ...
        this._schoolStatusID = this.props.match.params.id;
    }
...
class SchoolStatus extends Component {
    ...
    handleSubmit(e, formData, inputs) {
        ...
        let url = 'school/statuses';
        if (this._schoolStatusID) {
            formData['_method'] = 'PUT';
            url = `school/statuses/${this._schoolStatusID}`;
        }
    ...
    render() {
        ...
        return (
            <div className="row">
                ...
                <div className="col-md-6">
                    <Link className="btn btn-success" to={'/school-statuses'}>Add New</Link>
