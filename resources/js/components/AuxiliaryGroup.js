...
class TableList extends Component {
    ...
    constructor(props){
        ...
        this._auxiliaryGroupID = this.props.match.params.id;
    }
...
class AuxiliaryGroup extends Component {
    _isMounted = false;
    _isFormSubmit =  false;
    _auxiliaryGroupID = null;
    constructor(props){
        super(props);
    ...
    selectedItem(e, item) {
        this._auxiliaryGroupID = item.id;
    ...
    handleSubmit(e, formData, inputs) {
        ...
        let url = 'auxiliary-groups';
        if (this._auxiliaryGroupID) {
            formData['_method'] = 'PUT';
            url = `auxiliary-groups/${this._auxiliaryGroupID}`;
        }
    ...
    render() {
        ...
        return (
            <div className="row">
                ...
                <div className="col-md-6">
                    <Link className="btn btn-success" to={'/auxiliary-groups'}>Add New</Link>
