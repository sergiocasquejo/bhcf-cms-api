...
class ClassCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = \App\ClassCategory::select(\DB::raw('*'));
        if ($keywords) {
    ...
    {  
        try {
            ...
            $classCategory = new \App\ClassCategory($input);
    ...
    {
        return response()->json(['data' => \App\ClassCategory::findOrFail($id)]);
    }
    ...
    public function update(SchoolStatusUpdateRequest $request, $id)
    {
        ...
        try {
            ...
            if ($result = \App\ClassCategory::find($id)->update($input)) {
    ...
    {
        return response()->json(['ok' => \App\ClassCategory::findOrFail($id)->delete()]);
    }
}
